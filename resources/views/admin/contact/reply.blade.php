...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reply_contact_email',Crypt::encryptString($contacts->id)) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col mb-12">
                        ...
                        <textarea type="text" class="form-control" name="reply_message" required></textarea>
                    </div>
