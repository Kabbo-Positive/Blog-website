...
<head>
    ...
    <link href="{{ asset('front-end/css/bootstrap.min.css') }}" rel="stylesheet" /> <!-- https://getbootstrap.com/ -->
    <link href="{{ asset('front-end/fontawesome/css/all.min.css')}}" rel="stylesheet" /> <!-- https://fontawesome.com/ -->
    <link href="{{ asset('front-end/css/templatemo-business-oriented.css') }}" rel="stylesheet" />
</head>
<!--
...
-->
<body>
    <div id="parallax-1" class="parallax-window" data-parallax="scroll" data-image-src="{{ asset('front-end/img/biz-oriented-header.jpg')}}">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="tm-logo">
                        <i class="fas fa-industry fa-5x mr-5"></i>
                        <span class="text-uppercase tm-logo-text">Photography Business Oriented</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <nav class="navbar navbar-expand-lg" id="tm-main-nav">
                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="services.html">Photography</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link tm-nav-link" href="services.html">Blog</a>
                                </li>
                                <li class="nav-item">
    ...
    <div class="container-fluid mt-7">
        <div class="row mb-6">
            <section class="col-lg-6 mb-lg-0 mb-5">
                <div class="tm-intro">
                    <h3 class="tm-title-gray mb-4">What is a Photography Business Oriented Website?</h3>
                    <hr class="mb-5 tm-hr">
                    <p class="mb-5">Header is a parallax background just like in <a href="https://templatemo.com/tm-547-real-dynamic" target="_blank">Real Dynamic design</a> on TemplateMo.Photography Business Oriented HTML Template is specifically designed for your corporate website.</p>
                    ...
                    <img src="{{ asset('front-end/img/biz-oriented-1.jpg')}}" alt="Company Background Image" class="img-fluid tm-mb-3">
                </div>
            </section>
            <section class="col-lg-6">
                <h3 class="tm-title-gray mb-4">Photography Blog</h3>
                <hr class="mb-5 tm-hr">
                <div class="tm-strategy-box mb-5">
                    <img src="{{ asset('front-end/img/strategy-1.jpg')}}" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
                ...
                <div class="tm-strategy-box mb-5">
                    <img src="{{ asset('front-end/img/strategy-2.jpg')}}" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
                ...
                <div class="tm-strategy-box mb-5">
                    <img src="{{ asset('front-end/img/strategy-3.jpg')}}" alt="Image" class="img-fluid tm-strategy-img">
                    <div>
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-4 col-md-6">
                <img src="{{ asset('front-end/img/biz-oriented-2.jpg')}}" alt="Image" class="img-fluid">
    ...
    <div id="parallax-2" class="parallax-window parallax-window-2" data-parallax="scroll"
        data-image-src="{{ asset('front-end/img/biz-oriented-footer.jpg')}}">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
    ...
    <footer class="container-fluid">
        <div class="row">
            <p class="col-lg-9 col-md-8 mb-5 mb-md-0">
                Copyright &copy; 2022 <span class="tm-text-primary">Business Oriented</span>
                - designed by <a rel="nofollow" target="_parent" href="https://templatemo.com" class="tm-link-primary">Kabbo Hridoy</a>
            </p>
    ...
    <script src="{{ asset('front-end/js/parallax.min.js') }}"></script> <!-- https://pixelcog.github.io/parallax.js/ -->
    <script src="{{ asset('front-end/js/tooplate-script.js') }}"></script>
    <script>
